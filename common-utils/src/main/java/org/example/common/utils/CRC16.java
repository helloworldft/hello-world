...
/**
 * Created by heqingfu on 2020/4/7.
 */
/**
...
//        wCRCin &= 0xffff;
    ...
    public static int CRC16_XMODEM(byte[] buffer) {
        int wCRCin = 0xa1ec; // initial value 65535
    ...
    public static void main (String [] args) {
        String str = "3aa300000001211202000010014800260901520000014000031800012112020000100148ffffffffffff180608020304301684312300";
        byte[] bytes = CRC16.toByteArray(str);

        System.out.println(CRC16.CRC16_XMODEM(bytes));
        System.out.println(CRC16.CRC16_CCITT_FALSE(bytes));
